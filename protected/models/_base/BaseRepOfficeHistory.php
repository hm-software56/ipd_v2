...
/**
 * This is the model base class for the table "rep_office_history".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "RepOfficeHistory".
 *
 * Columns in table "rep_office_history" available as properties of the model,
...
abstract class BaseRepOfficeHistory extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('id, inc_document_id, first_name, last_name, birth_date, nationality, parent_company, register_place, business, objective, province_id, district_id, village_id, capital, fixed_asset, cash, user_action_id, action_time', 'required'),
			array('id, inc_document_id, province_id, district_id, village_id, capital, fixed_asset, cash, user_action_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, inc_document_id, first_name, last_name, birth_date, nationality, parent_company, register_place, business, objective, house_no, province_id, district_id, village_id, capital, fixed_asset, cash, user_action_id, action_time', 'safe', 'on'=>'search'),
		);
	}
