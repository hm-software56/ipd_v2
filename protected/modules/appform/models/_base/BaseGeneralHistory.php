...
/**
 * This is the model base class for the table "appform_general_history".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "GeneralHistory".
 *
 * Columns in table "appform_general_history" available as properties of the model,
...
abstract class BaseGeneralHistory extends GxActiveRecord {
	...
	public function tableName() {
		return 'appform_general_history';
	}
	...
	public function rules() {
		return array(
			...
			array('application_form_id, user_action_id', 'numerical', 'integerOnly'=>true),
