...
$columns = array(
    ...
    array(
        ...
        'template'=>'{delete}',
        'deleteButtonUrl'=>'Yii::app()->controller->createUrl("removeSite",array("province_id"=>$data->province_id,"district_id"=>$data->district_id,"village_id"=>$data->village_id,"app_type"=>"mining"))',
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'template'=>'{items}',
    'dataProvider' => $mining->getSiteProvider(),
    'columns' => $columns,
));
?>