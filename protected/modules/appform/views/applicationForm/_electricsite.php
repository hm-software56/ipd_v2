...
$columns = array(
    ...
    array(
        ...
        'template'=>'{delete}',
        'deleteButtonUrl'=>'Yii::app()->controller->createUrl("removeSite",array("province_id"=>$data->province_id,"district_id"=>$data->district_id,"village_id"=>$data->village_id,"app_type"=>"electric"))',
        'visible'=>Yii::app()->controller->action->id!="view",
    )
);
?>
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    'id' => 'electric-site-grid',
    'type' => 'striped bordered condensed',
    'template'=>'{items}',
    'dataProvider' => $electric->getSiteProvider(),
    'columns' => $columns,
));
?>