...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	//	'document_id',
        ...
        array(
        	...
        	'type'=>'raw',
        	//'value'=>'!empty(IncDocument::model()->findByPk($data->document->related_document_id)->related_document_id)?"\'IncDocument::model()->findByPk($data->document->related_document_id\'":""',
        	'value'=>'IncDocument::model()->getrelInc($data->document->related_document_id)',
