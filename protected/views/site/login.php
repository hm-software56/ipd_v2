	<div class="row">
    <section class="b vh100 bannerSection " id="particles-js">
        <div class="bannerSectionInner ">
                <div id="login_l">
					...
					?>
						...
						<?php $this->endWidget(); ?>
						<div align="center">
							<a style="color:#fff" href="#myModal" role="button" class="btn btn-link" data-toggle="modal">ຄົ້ນ​ຫາ​ເອ​ກະ​ສານສະ​ເພາະ​ຜູ້​ລົງ​ທຶນ >></a>
						</div>
					</div>
				</div>
        </div>

    <canvas class="particles-js-canvas-el" width="1583" height="465" style="width: 100%; height: 100%;"></canvas>
	</section>
				</div>
    <script src="http://ipdv2/bg/css/particles.min.js.download"></script>
    <script src="http://ipdv2/bg//css/app.js.download"></script>
