...
return array(
	...
	'components'=>array(
		...
		'mail'=>array(
            ...
            'transportType'=>'smtp',
            'transportOptions'=>array(
                'host'=>'sr9.supercp.com',
                'username'=>'ipd@investlaos.gov.la',
                'password'=>'ipd85621217012',
                'port'=>465,
                'encryption'=>'tls',
            ),
            'viewPath'=>'application.views.mail',
	...
	'params'=>array(
		...
		'IsApppagiculture'=>13, //fixed ID is application get form id documentType
		'IsAppGeneral'=>22, //fixed ID is application get form id documentType
		'IsAppGeneral1'=>23, //fixed ID is application get form id documentType
		'IsAppGeneral2'=>24, //fixed ID is application get form id documentType
		'IsAppGeneral3'=>25, //fixed ID is application get form id documentType
		'IsAppGeneral4'=>26, //fixed ID is application get form id documentType
		'IsAppGeneral5'=>27, //fixed ID is application get form id documentType
		'IsAppGeneral6'=>58, //fixed ID is application get form id documentType
